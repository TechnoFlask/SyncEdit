...
import { useRecentFonts } from "@/app/document/editor/RecentFonts";
  ...
  return (
    <DropdownMenu onOpenChange={(open) => setOpen(open)}>
      <DropdownMenuTrigger asChild>
        <button
          className="flex w-32 cursor-pointer items-center justify-between gap-1 truncate rounded-sm p-1 text-lg hover:bg-gray-300 focus:outline-none"
          style={{
